...
public final class PreverseHelp extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(lst) then sofar else reverseHelp(tail(lst), (head(lst) :: sofar))
		 return (common.ConsCell)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PreverseHelp.i_lst)})) ? ((common.ConsCell)context.childAsIs(core.PreverseHelp.i_sofar)) : ((common.ConsCell)core.PreverseHelp.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PreverseHelp.i_lst)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PreverseHelp.i_lst)})); } }, context.childAsIsLazy(core.PreverseHelp.i_sofar)})); } }}))));
