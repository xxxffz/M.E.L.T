...
public final class PcontainsBy extends common.FunctionNode {
	...
	public static Boolean invoke(final Object[] args) {
		...
		//(! null(lst)) && (eq(elem, head(lst)) || containsBy(eq, elem, tail(lst)))
		 return (Boolean)(((!((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PcontainsBy.i_lst)}))) && (((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PcontainsBy.i_eq)).invoke(new Object[]{context.childAsIsLazy(core.PcontainsBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PcontainsBy.i_lst)})); } }})) || ((Boolean)core.PcontainsBy.invoke(new Object[]{context.childAsIsLazy(core.PcontainsBy.i_eq), context.childAsIsLazy(core.PcontainsBy.i_elem), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PcontainsBy.i_lst)})); } }})))));
