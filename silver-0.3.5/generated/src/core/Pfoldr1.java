...
public final class Pfoldr1 extends common.FunctionNode {
	...
	public static Object invoke(final Object[] args) {
		...
		//if null(l) then error("Applying foldr1 to empty list.") else if null(tail(l)) then head(l) else f(head(l), foldr1(f, tail(l)))
		 return (Object)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr1.i_l)})) ? ((Object)core.Perror.invoke(new Object[]{(new common.StringCatter("Applying foldr1 to empty list."))})) : (((Boolean)core.Pnull.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr1.i_l)})); } }})) ? ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr1.i_l)})) : ((Object)((common.NodeFactory<Object>)context.childAsIs(core.Pfoldr1.i_f)).invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr1.i_l)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pfoldr1.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr1.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr1.i_l)})); } }})); } }})))));
