...
public final class PgroupBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(l) then [] else (helpercall.fst :: if null(helpercall.snd) then [] else groupBy(eq, helpercall.snd))
		 return (common.ConsCell)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PgroupBy.i_l)})) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.helpercall__ON__core_groupBy).synthesized(core.Init.core_fst__ON__core_Pair)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)core.Pnull.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.helpercall__ON__core_groupBy).synthesized(core.Init.core_snd__ON__core_Pair)); } }})) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.PgroupBy.invoke(new Object[]{context.childAsIsLazy(core.PgroupBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)context.localDecorated(core.Init.helpercall__ON__core_groupBy).synthesized(core.Init.core_snd__ON__core_Pair)); } }}))); } }}))));
