...
public final class PexplodeSingle extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if length(str) == 0 then [] else (substring(0, 1, str) :: explodeSingle(substring(1, length(str), str)))
		 return (common.ConsCell)((Integer.valueOf(((common.StringCatter)((common.StringCatter)context.childAsIs(core.PexplodeSingle.i_str))).length()).equals(Integer.valueOf((int)0)) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.StringCatter)core.Psubstring.invoke(new Object[]{Integer.valueOf((int)0), Integer.valueOf((int)1), context.childAsIsLazy(core.PexplodeSingle.i_str)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PexplodeSingle.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.StringCatter)core.Psubstring.invoke(new Object[]{Integer.valueOf((int)1), new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((common.StringCatter)((common.StringCatter)context.childAsIs(core.PexplodeSingle.i_str))).length()); } }, context.childAsIsLazy(core.PexplodeSingle.i_str)})); } }})); } }}))));
