...
public final class PindexOf extends common.FunctionNode {
	...
	public static Integer invoke(final Object[] args) {
		try {
		return (Integer)Integer.valueOf(((common.StringCatter)(args[i_haystack] = common.Util.demand(args[i_haystack]))).toString().indexOf(((common.StringCatter)(args[i_needle] = common.Util.demand(args[i_needle]))).toString()));
