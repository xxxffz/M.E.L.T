...
public final class Pdrop extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(lst) || number <= 0 then lst else drop(number - 1, tail(lst))
		 return (common.ConsCell)(((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.Pdrop.i_lst)})) || (((Integer)context.childAsIs(core.Pdrop.i_number)) <= Integer.valueOf((int)0))) ? ((common.ConsCell)context.childAsIs(core.Pdrop.i_lst)) : ((common.ConsCell)core.Pdrop.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.childAsIs(core.Pdrop.i_number)) - Integer.valueOf((int)1)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pdrop.i_lst)})); } }}))));
