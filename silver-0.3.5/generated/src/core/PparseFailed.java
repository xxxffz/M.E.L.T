...
public final class PparseFailed extends core.NParseResult {
	...
	static void initProductionAttributeDefinitions() {
		...
		core.PparseFailed.synthesizedAttributes[core.Init.core_parseTree__ON__core_ParseResult] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((Object)core.Perror.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return new common.StringCatter((common.StringCatter)(new common.StringCatter("Demanded parse tree when parsing failed! With errors: ")), (common.StringCatter)((common.StringCatter)context.childAsIs(core.PparseFailed.i_e))); } }})); } };
	}
