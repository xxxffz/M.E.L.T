...
public final class PremoveAllBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(ys) then xs else removeAllBy(eq, tail(ys), removeBy(eq, head(ys), xs))
		 return (common.ConsCell)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PremoveAllBy.i_ys)})) ? ((common.ConsCell)context.childAsIs(core.PremoveAllBy.i_xs)) : ((common.ConsCell)core.PremoveAllBy.invoke(new Object[]{context.childAsIsLazy(core.PremoveAllBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PremoveAllBy.i_ys)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PremoveBy.invoke(new Object[]{context.childAsIsLazy(core.PremoveAllBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PremoveAllBy.i_ys)})); } }, context.childAsIsLazy(core.PremoveAllBy.i_xs)})); } }}))));
