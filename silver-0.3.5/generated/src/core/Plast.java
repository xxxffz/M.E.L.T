...
public final class Plast extends common.FunctionNode {
	...
	public static Object invoke(final Object[] args) {
		...
		//if null(tail(lst)) then head(lst) else last(tail(lst))
		 return (Object)((((Boolean)core.Pnull.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Plast.i_lst)})); } }})) ? ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Plast.i_lst)})) : ((Object)core.Plast.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Plast.i_lst)})); } }}))));
