...
public final class Pintersperse extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(xs) then [] else if null(tail(xs)) then xs else (head(xs) :: (sep :: intersperse(sep, tail(xs))))
		 return (common.ConsCell)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.Pintersperse.i_xs)})) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : (((Boolean)core.Pnull.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pintersperse.i_xs)})); } }})) ? ((common.ConsCell)context.childAsIs(core.Pintersperse.i_xs)) : ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Pintersperse.i_xs)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pcons.invoke(new Object[]{context.childAsIsLazy(core.Pintersperse.i_sep), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pintersperse.invoke(new Object[]{context.childAsIsLazy(core.Pintersperse.i_sep), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pintersperse.i_xs)})); } }})); } }})); } }})))));
