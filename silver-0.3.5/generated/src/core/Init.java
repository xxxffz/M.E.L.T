...
public class Init{
	...
	private static void initProductionAttributeDefinitions(){
		...
		//FUNCTION map Decorated core:List<b> ::= f::(b ::= a) l::Decorated core:List<a> 
		//FUNCTION foldr b ::= f::(b ::= a b) i::b l::Decorated core:List<a> 
		//FUNCTION foldl b ::= f::(b ::= b a) i::b l::Decorated core:List<a> 
		//FUNCTION foldr1 a ::= f::(a ::= a a) l::Decorated core:List<a> 
		//FUNCTION foldl1 a ::= f::(a ::= a a) l::Decorated core:List<a> 
		//FUNCTION filter Decorated core:List<a> ::= f::(Boolean ::= a) lst::Decorated core:List<a> 
		//FUNCTION partition Pair<Decorated core:List<a> Decorated core:List<a>> ::= f::(Boolean ::= a) lst::Decorated core:List<a> 
		// recurse = partition(f, tail(lst))
		core.Ppartition.localAttributes[core.Init.recurse__ON__core_partition] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((core.NPair)core.Ppartition.invoke(new Object[]{context.childAsIsLazy(core.Ppartition.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Ppartition.i_lst)})); } }})); } };
		//FUNCTION containsBy Boolean ::= eq::(Boolean ::= a a) elem::a lst::Decorated core:List<a> 
		//FUNCTION nubBy Decorated core:List<a> ::= eq::(Boolean ::= a a) xs::Decorated core:List<a> 
		//FUNCTION removeBy Decorated core:List<a> ::= eq::(Boolean ::= a a) x::a xs::Decorated core:List<a> 
		//FUNCTION removeAllBy Decorated core:List<a> ::= eq::(Boolean ::= a a) ys::Decorated core:List<a> xs::Decorated core:List<a> 
		...
		//FUNCTION dropWhile Decorated core:List<a> ::= f::(Boolean ::= a) lst::Decorated core:List<a> 
		//FUNCTION takeWhile Decorated core:List<a> ::= f::(Boolean ::= a) lst::Decorated core:List<a> 
		//FUNCTION takeUntil Decorated core:List<a> ::= f::(Boolean ::= a) lst::Decorated core:List<a> 
		//FUNCTION positionOf Integer ::= eq::(Boolean ::= a a) x::a xs::Decorated core:List<a> 
		//FUNCTION positionOfHelper Integer ::= eq::(Boolean ::= a a) x::a xs::Decorated core:List<a> currentPos::Integer 
		//FUNCTION repeat Decorated core:List<a> ::= v::a times::Integer 
		//FUNCTION zipWith Decorated core:List<c> ::= f::(c ::= a b) l1::Decorated core:List<a> l2::Decorated core:List<b> 
		...
		//FUNCTION sortBy Decorated core:List<a> ::= lte::(Boolean ::= a a) lst::Decorated core:List<a> 
		//FUNCTION sortByHelp Decorated core:List<a> ::= lte::(Boolean ::= a a) lst::Decorated core:List<a> upTo::Integer 
		...
		core.PsortByHelp.localAttributes[core.Init.back_half__ON__core_sortByHelp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.PsortByHelp.invoke(new Object[]{context.childAsIsLazy(core.PsortByHelp.i_lte), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pdrop.invoke(new Object[]{context.localAsIsLazy(core.Init.middle__ON__core_sortByHelp), context.childAsIsLazy(core.PsortByHelp.i_lst)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.childAsIs(core.PsortByHelp.i_upTo)) - ((Integer)context.localAsIs(core.Init.middle__ON__core_sortByHelp))); } }})); } };
		...
		//FUNCTION mergeBy Decorated core:List<a> ::= lte::(Boolean ::= a a) l1::Decorated core:List<a> l2::Decorated core:List<a> 
		//FUNCTION groupBy Decorated core:List<Decorated core:List<a>> ::= eq::(Boolean ::= a a) l::Decorated core:List<a> 
		// helpercall = groupByHelp(eq, head(l), l)
		core.PgroupBy.localAttributes[core.Init.helpercall__ON__core_groupBy] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((core.NPair)core.PgroupByHelp.invoke(new Object[]{context.childAsIsLazy(core.PgroupBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PgroupBy.i_l)})); } }, context.childAsIsLazy(core.PgroupBy.i_l)})); } };
		//FUNCTION groupByHelp Pair<Decorated core:List<a> Decorated core:List<a>> ::= eq::(Boolean ::= a a) f::a l::Decorated core:List<a> 
		// recurse = groupByHelp(eq, f, tail(l))
		core.PgroupByHelp.localAttributes[core.Init.recurse__ON__core_groupByHelp] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((core.NPair)core.PgroupByHelp.invoke(new Object[]{context.childAsIsLazy(core.PgroupByHelp.i_eq), context.childAsIsLazy(core.PgroupByHelp.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PgroupByHelp.i_l)})); } }})); } };
		//FUNCTION intersperse Decorated core:List<a> ::= sep::a xs::Decorated core:List<a> 
		//FUNCTION unionBy Decorated core:List<a> ::= eq::(Boolean ::= a a) l::Decorated core:List<a> r::Decorated core:List<a> 
		//FUNCTION intersectBy Decorated core:List<a> ::= eq::(Boolean ::= a a) l::Decorated core:List<a> r::Decorated core:List<a> 
		//FUNCTION unionsBy Decorated core:List<a> ::= eq::(Boolean ::= a a) ss::Decorated core:List<Decorated core:List<a>> 
		...
		//FUNCTION lookupBy Maybe<b> ::= eqf::(Boolean ::= a a) elem::a lst::Decorated core:List<Pair<a b>> 
