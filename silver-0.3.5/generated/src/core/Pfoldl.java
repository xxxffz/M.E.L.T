...
public final class Pfoldl extends common.FunctionNode {
	...
	public static Object invoke(final Object[] args) {
		...
		//if null(l) then i else foldl(f, f(i, head(l)), tail(l))
		 return (Object)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl.i_l)})) ? ((Object)context.childAsIs(core.Pfoldl.i_i)) : ((Object)core.Pfoldl.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)((common.NodeFactory<Object>)context.childAsIs(core.Pfoldl.i_f)).invoke(new Object[]{context.childAsIsLazy(core.Pfoldl.i_i), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl.i_l)})); } }})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl.i_l)})); } }}))));
