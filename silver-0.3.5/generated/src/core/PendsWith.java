...
public final class PendsWith extends common.FunctionNode {
	...
	public static Boolean invoke(final Object[] args) {
		try {
		return (Boolean)Boolean.valueOf(((common.StringCatter)(args[i_s] = common.Util.demand(args[i_s]))).toString().endsWith(((common.StringCatter)(args[i_post] = common.Util.demand(args[i_post]))).toString()));
