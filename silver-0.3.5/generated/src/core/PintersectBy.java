...
public final class PintersectBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(l) then [] else (if containsBy(eq, head(l), r) then [ head(l) ] else []) ++ intersectBy(eq, tail(l), r)
		 return (common.ConsCell)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PintersectBy.i_l)})) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.Pappend.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)core.PcontainsBy.invoke(new Object[]{context.childAsIsLazy(core.PintersectBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PintersectBy.i_l)})); } }, context.childAsIsLazy(core.PintersectBy.i_r)})) ? ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PintersectBy.i_l)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke(new Object[]{})); } }})) : ((common.ConsCell)core.Pnil.invoke(new Object[]{}))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PintersectBy.invoke(new Object[]{context.childAsIsLazy(core.PintersectBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PintersectBy.i_l)})); } }, context.childAsIsLazy(core.PintersectBy.i_r)})); } }}))));
