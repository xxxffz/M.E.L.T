...
public final class Prepeat extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if times <= 0 then [] else (v :: repeat(v, times - 1))
		 return (common.ConsCell)(((((Integer)context.childAsIs(core.Prepeat.i_times)) <= Integer.valueOf((int)0)) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.Pcons.invoke(new Object[]{context.childAsIsLazy(core.Prepeat.i_v), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Prepeat.invoke(new Object[]{context.childAsIsLazy(core.Prepeat.i_v), new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(((Integer)context.childAsIs(core.Prepeat.i_times)) - Integer.valueOf((int)1)); } }})); } }}))));
