...
public final class Pfoldl1 extends common.FunctionNode {
	...
	public static Object invoke(final Object[] args) {
		...
		//if null(l) then error("Applying foldl1 to empty list.") else foldl(f, head(l), tail(l))
		 return (Object)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl1.i_l)})) ? ((Object)core.Perror.invoke(new Object[]{(new common.StringCatter("Applying foldl1 to empty list."))})) : ((Object)core.Pfoldl.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl1.i_f), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl1.i_l)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pfoldl1.i_l)})); } }}))));
