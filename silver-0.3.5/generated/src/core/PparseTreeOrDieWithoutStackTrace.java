...
public final class PparseTreeOrDieWithoutStackTrace extends common.FunctionNode {
	...
	public static Object invoke(final Object[] args) {
		...
		//unsafeTrace(pr.parseTree, if pr.parseSuccess then unsafeIO() else exit(- 1, print(pr.parseErrors ++ "\n\n", unsafeIO())))
		 return (Object)(((Object)core.PunsafeTrace.invoke(new Object[]{context.childSynthesizedLazy(core.PparseTreeOrDieWithoutStackTrace.i_pr, core.Init.core_parseTree__ON__core_ParseResult), new common.Thunk<Object>(context) { public final Object doEval() { return (((Boolean)context.childDecorated(core.PparseTreeOrDieWithoutStackTrace.i_pr).synthesized(core.Init.core_parseSuccess__ON__core_ParseResult)) ? ((Object)core.PunsafeIO.invoke(new Object[]{})) : ((Object)core.Pexit.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return Integer.valueOf(-Integer.valueOf((int)1)); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pprint.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return new common.StringCatter((common.StringCatter)((common.StringCatter)context.childDecorated(core.PparseTreeOrDieWithoutStackTrace.i_pr).synthesized(core.Init.core_parseErrors__ON__core_ParseResult)), (common.StringCatter)(new common.StringCatter("\n\n"))); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.PunsafeIO.invoke(new Object[]{})); } }})); } }}))); } }})));
