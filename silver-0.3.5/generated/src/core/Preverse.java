...
public final class Preverse extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//reverseHelp(lst, [])
		 return (common.ConsCell)(((common.ConsCell)core.PreverseHelp.invoke(new Object[]{context.childAsIsLazy(core.Preverse.i_lst), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Pnil.invoke(new Object[]{})); } }})));
