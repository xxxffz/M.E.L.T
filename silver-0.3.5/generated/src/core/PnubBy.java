...
public final class PnubBy extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(xs) then [] else (head(xs) :: nubBy(eq, removeBy(eq, head(xs), tail(xs))))
		 return (common.ConsCell)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PnubBy.i_xs)})) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PnubBy.i_xs)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PnubBy.invoke(new Object[]{context.childAsIsLazy(core.PnubBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.PremoveBy.invoke(new Object[]{context.childAsIsLazy(core.PnubBy.i_eq), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PnubBy.i_xs)})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PnubBy.i_xs)})); } }})); } }})); } }}))));
