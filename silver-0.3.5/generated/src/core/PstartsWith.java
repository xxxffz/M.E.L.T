...
public final class PstartsWith extends common.FunctionNode {
	...
	public static Boolean invoke(final Object[] args) {
		try {
		return (Boolean)Boolean.valueOf(((common.StringCatter)(args[i_s] = common.Util.demand(args[i_s]))).toString().startsWith(((common.StringCatter)(args[i_pre] = common.Util.demand(args[i_pre]))).toString()));
