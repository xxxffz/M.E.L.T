...
public final class Pparse extends common.FunctionNode {
	...
	public static final int num_local_attrs = Init.count_local__ON__simple_composed_simple_all_parse;
	...
	public String getName() {
		return "simple:composed:simple_all:parse";
	}

	public static core.NParseResult invoke(final Object[] args) {
		try {
		try {
			return new core.PparseSucceeded( new simple.composed.simple_all.Parser_simple_composed_simple_all_parse().parse(new java.io.StringReader(((common.StringCatter)common.Util.demand(args[0])).toString()), ((common.StringCatter)common.Util.demand(args[1])).toString()) );
		...
		} catch(Throwable t) { throw new common.exceptions.TraceException("Error while evaluating function simple:composed:simple_all:parse", t); }
	}
