...
public final class PrealLine extends silver.langutil.pp.NDocument {
	...
	public PrealLine(final Object[] args) {
		super(args);
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		// top.horizontals = []
		silver.langutil.pp.PrealLine.synthesizedAttributes[silver.langutil.pp.Init.silver_langutil_pp_horizontals__ON__silver_langutil_pp_Document] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pnil.invoke(new Object[]{})); } };
	}
	...
	public static final class Factory extends common.NodeFactory<PrealLine> {
		...
		@Override
		public PrealLine invoke(final Object[] children) {
			return new PrealLine(children);
		}
