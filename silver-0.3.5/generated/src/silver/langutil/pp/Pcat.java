...
public final class Pcat extends silver.langutil.pp.NDocument {
	...
	public Pcat(final Object c_d1, final Object c_d2) {
		this(new Object[]{c_d1, c_d2});
	}

	public Pcat(final Object[] args) {
		super(args);
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.langutil.pp.Pcat.synthesizedAttributes[silver.langutil.pp.Init.silver_langutil_pp_horizontals__ON__silver_langutil_pp_Document] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.ConsCell)core.Pappend.invoke(new Object[]{context.childSynthesizedLazy(silver.langutil.pp.Pcat.i_d1, silver.langutil.pp.Init.silver_langutil_pp_horizontals__ON__silver_langutil_pp_Document), context.childSynthesizedLazy(silver.langutil.pp.Pcat.i_d2, silver.langutil.pp.Init.silver_langutil_pp_horizontals__ON__silver_langutil_pp_Document)})); } };
	}
	...
	public static final class Factory extends common.NodeFactory<Pcat> {
		...
		@Override
		public Pcat invoke(final Object[] children) {
			return new Pcat(children);
		}
