...
public final class Pline extends silver.langutil.pp.NDocument {
	...
	public Pline(final Object[] args) {
		super(args);
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		silver.langutil.pp.Pline.localAttributes[silver.langutil.pp.Init.horizontal__ON__silver_langutil_pp_line] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((Boolean)core.Phead.invoke(new Object[]{context.contextInheritedLazy(silver.langutil.pp.Init.silver_langutil_pp_inCHorizontals__ON__silver_langutil_pp_Document)})); } };
	...
	public static final class Factory extends common.NodeFactory<Pline> {
		...
		@Override
		public Pline invoke(final Object[] children) {
			return new Pline(children);
		}
