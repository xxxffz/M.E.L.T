...
public final class Psemi extends common.FunctionNode {


	public static final Class<?> childTypes[] = {};

	public static final int num_local_attrs = Init.count_local__ON__silver_langutil_pp_semi;
	...
	public Psemi(final Object[] args) {
		super(args);
	}
	...
	public String getName() {
		return "silver:langutil:pp:semi";
	}

	public static silver.langutil.pp.NDocument invoke(final Object[] args) {
		try {
		final common.DecoratedNode context = new Psemi(args).decorate(common.TopNode.singleton, (common.Lazy[])null);
		//text(";")
		 return (silver.langutil.pp.NDocument)(((silver.langutil.pp.NDocument)new silver.langutil.pp.Ptext((new common.StringCatter(";")))));
		} catch(Throwable t) { throw new common.exceptions.TraceException("Error while evaluating function silver:langutil:pp:semi", t); }
	}
