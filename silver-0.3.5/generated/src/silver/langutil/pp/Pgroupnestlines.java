...
public final class Pgroupnestlines extends common.FunctionNode {
	...
	public Pgroupnestlines(final Object[] args) {
		super(args);
	}
	...
	public static silver.langutil.pp.NDocument invoke(final Object[] args) {
		try {
		final common.DecoratedNode context = new Pgroupnestlines(args).decorate(common.TopNode.singleton, (common.Lazy[])null);
		//cat(groupnest(n, cat(line(), inner)), line())
		 return (silver.langutil.pp.NDocument)(((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)silver.langutil.pp.Pgroupnest.invoke(new Object[]{context.childAsIsLazy(silver.langutil.pp.Pgroupnestlines.i_n), new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pcat(new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pline()); } }, common.Thunk.transformUndecorate(context.childDecoratedLazy(silver.langutil.pp.Pgroupnestlines.i_inner)))); } }})); } }, new common.Thunk<Object>(context) { public final Object doEval() { return ((silver.langutil.pp.NDocument)new silver.langutil.pp.Pline()); } })));
		} catch(Throwable t) { throw new common.exceptions.TraceException("Error while evaluating function silver:langutil:pp:groupnestlines", t); }
	}
	...
	public static final class Factory extends common.NodeFactory<silver.langutil.pp.NDocument> {
		...
		public silver.langutil.pp.NDocument invoke(final Object[] args) {
			return Pgroupnestlines.invoke(args);
		}
