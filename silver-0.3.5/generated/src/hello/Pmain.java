...
public final class Pmain extends common.FunctionNode {
	...
	public static core.NIOVal invoke(final Object[] args) {
		...
		//ioval(print(" World!\n", print("Hello", ioin)), 0)
		 return (core.NIOVal)(((core.NIOVal)new core.Pioval(new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pprint.invoke(new Object[]{(new common.StringCatter(" World!\n")), new common.Thunk<Object>(context) { public final Object doEval() { return ((Object)core.Pprint.invoke(new Object[]{(new common.StringCatter("Hello")), context.childAsIsLazy(hello.Pmain.i_ioin)})); } }})); } }, Integer.valueOf((int)0))));
