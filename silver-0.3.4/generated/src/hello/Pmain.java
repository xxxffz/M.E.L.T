...
public final class Pmain extends common.FunctionNode {
	...
	public static core.NIOVal invoke(final Object[] args) {
		...
		//ioval(print(toString(pow(base, exp)), ioin), 0)
		 return (core.NIOVal)(((core.NIOVal)new core.Pioval(new common.Closure(context) { public final Object eval() { return ((Object)core.Pprint.invoke(new Object[]{new common.Closure(context) { public final Object eval() { return (new common.StringCatter(String.valueOf(((Integer)hello.Ppow.invoke(new Object[]{context.localAsIsLazy(hello.Init.base__ON__hello_main), context.localAsIsLazy(hello.Init.exp__ON__hello_main)}))))); } }, context.childAsIsLazy(hello.Pmain.i_ioin)})); } }, Integer.valueOf((int)0))));
